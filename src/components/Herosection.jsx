    ...
    return (
        <section id="home">
            <div className="grid grid-cols-1 h-screen md:grid-cols-2 xl:grid-cols-3 2xl:grid-col-3">
                ...
                <div className="order-first mx-auto xl:mx-0 md:mx-0 2xl:mx-0 md:order-first bg-gradient-to-b from-slate-50 to-slate-400 rounded-full shadow-2xl md:col-span-1 xl:col-span-1 xl:order-none my-auto bg-cover bg-center" style={{ width: '100%', height: '75%' }}>
